...
interface PublicTimelineDay {
  date: Date;
  dateStr: string;
  events: { id: string }[];
}

interface PublicDayNavProps {
  days: PublicTimelineDay[];
  selectedDayIndex: number | null;
  onDaySelect: (index: number) => void;
}

export function PublicDayNav({ days, selectedDayIndex, onDaySelect }: PublicDayNavProps) {
  return (
